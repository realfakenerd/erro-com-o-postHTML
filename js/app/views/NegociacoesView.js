...
System.register(['./Views', '../helpers/DateHelper', '../controllers/NegociacaoController'], function (_export, _context) {
    "use strict";

    var Views, DateHelper, currentInstance, _createClass, NegociacoesView;
    ...
    return {
        ...
        execute: function () {
            ...
            _export('NegociacoesView', NegociacoesView = function (_Views) {
                _inherits(NegociacoesView, _Views);
